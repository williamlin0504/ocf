...
func SendCreateSmContextRequest(
	ue *amf_context.OcfUe, smfUri string, nasPdu []byte, smContextCreateData models.SmContextCreateData) (
...
func BuildCreateSmContextRequest(ue *amf_context.OcfUe, pduSessionContext models.PduSessionContext,
	requestType models.RequestType) (smContextCreateData models.SmContextCreateData) {
	context := amf_context.OCF_Self()
...
func SendUpdateSmContextActivateUpCnxState(ue *amf_context.OcfUe, pduSessionId int32, accessType models.AccessType) (
...
func SendUpdateSmContextDeactivateUpCnxState(ue *amf_context.OcfUe, pduSessionId int32, cause amf_context.CauseAll) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	smContext, ok := ue.SmContextList[pduSessionId]
	if !ok {
		return nil, nil, nil, openapi.ReportError("[OCF] pduSessionId : %d is not in Ue", pduSessionId)
...
func SendUpdateSmContextChangeAccessType(ue *amf_context.OcfUe, pduSessionId int32, anTypeCanBeChanged bool) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	smContext, ok := ue.SmContextList[pduSessionId]
	if !ok {
		return nil, nil, nil, openapi.ReportError("[OCF] pduSessionId : %d is not in Ue", pduSessionId)
...
func SendUpdateSmContextN2Info(
	ue *amf_context.OcfUe, pduSessionId int32, n2SmType models.N2SmInfoType, N2SmInfo []byte) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	smContext, ok := ue.SmContextList[pduSessionId]
	if !ok {
		return nil, nil, nil, openapi.ReportError("[OCF] pduSessionId : %d is not in Ue", pduSessionId)
...
func SendUpdateSmContextN2HandoverPreparing(ue *amf_context.OcfUe, pduSessionId int32, n2SmType models.N2SmInfoType,
...
func SendUpdateSmContextN2HandoverComplete(
	ue *amf_context.OcfUe, pduSessionId int32, amfid string, guami *models.Guami) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	smContext, ok := ue.SmContextList[pduSessionId]
	if !ok {
		return nil, nil, nil, openapi.ReportError("[OCF] pduSessionId : %d is not in Ue", pduSessionId)
...
func SendUpdateSmContextN2HandoverCanceled(ue *amf_context.OcfUe, pduSessionId int32, cause amf_context.CauseAll) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	smContext, ok := ue.SmContextList[pduSessionId]
	if !ok {
		return nil, nil, nil, openapi.ReportError("[OCF] pduSessionId : %d is not in Ue", pduSessionId)
...
func SendUpdateSmContextHandoverBetweenAccessType(
	ue *amf_context.OcfUe, pduSessionId int32, targetAccessType models.AccessType, N1SmMsg []byte) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	smContext, ok := ue.SmContextList[pduSessionId]
	if !ok {
		return nil, nil, nil, openapi.ReportError("[OCF] pduSessionId : %d is not in Ue", pduSessionId)
...
func SendUpdateSmContextHandoverBetweenOCF(
	ue *amf_context.OcfUe, pduSessionId int32, amfid string, guami *models.Guami, activate bool) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	smContext, ok := ue.SmContextList[pduSessionId]
	if !ok {
		return nil, nil, nil, openapi.ReportError("[OCF] pduSessionId : %d is not in Ue", pduSessionId)
...
func SendUpdateSmContextRequest(ue *amf_context.OcfUe, smfUri, smContextRef string,
...
func BuildUpdateSmContextRequset(
	ue *amf_context.OcfUe, present UpdateSmContextPresent, pduSessionId int32, param updateSmContextRequsetParam) (
...
func BuildUpdateSmContextRequsetHandover(
	ue *amf_context.OcfUe, present UpdateSmContextPresent, pduSessionId int32, param updateSmContextRequsetHandoverParam) (
	updateData models.SmContextUpdateData) {
	smContext := ue.SmContextList[pduSessionId]
	context := amf_context.OCF_Self()
	if param.n2SmType != "" {
...
func SendReleaseSmContextRequest(ue *amf_context.OcfUe, pduSessionId int32,
...
func BuildReleaseSmContextRequest(
	ue *amf_context.OcfUe, cause *amf_context.CauseAll, n2SmInfoType models.N2SmInfoType, n2Info []byte) (
